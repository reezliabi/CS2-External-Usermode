...
namespace unknowncheats {
	...
	namespace dragged_offsets {
		inline DWORD entity_list = 0x17C1950;
		inline DWORD matrix = 0x1820150;
		inline DWORD view_angle = 0x1880DC0;
		inline DWORD local_player_controller = 0x1810F48;
		inline DWORD local_player_pawn = 0x16C8F58;
		inline DWORD force_jump = 0x16C23A0;
		inline DWORD global_vars = 0x16BDCB8;
		inline DWORD inventory_services;
		inline DWORD planted_c4 = 0x1824A88;
	}
